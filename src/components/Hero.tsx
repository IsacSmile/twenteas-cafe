...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[92vh] pt-32 pb-16 flex flex-col justify-between items-center overflow-hidden bg-[#140D08]">
      ...
      <div className="my-auto z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        {/* High-Fashion Letterpress Title */}
        ...
        {/* Single Pure Showcase CTA */}
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-12">
          <a
            href="#menu"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 border border-amber-500/40 hover:border-amber-400 bg-amber-600 hover:bg-amber-500 text-coffee-950 font-bold uppercase tracking-[0.2em] text-xs px-10 py-4 rounded-full shadow-2xl transition-all duration-300 active:scale-95 glow-gold"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 rounded-2xl bg-[#1C120B]/70 backdrop-blur-md border border-cream-100/10 text-xs text-cream-100/80">
          ...
          <div className="flex items-center gap-3 justify-center sm:justify-start">
            ...
            <div>
              ...
              <span className="text-[11px] text-cream-100/50">100% Outdoor Walk-in</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 justify-center sm:justify-start">
            ...
            <div>
              <span className="block font-medium text-cream-100">No Rush, No Queries</span>
              <span className="text-[11px] text-cream-100/50">Just Sit & Enjoy</span>
            </div>
          </div>
