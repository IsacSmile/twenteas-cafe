...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[92vh] pt-28 pb-16 sm:pt-36 sm:pb-20 flex flex-col justify-between items-center overflow-hidden bg-[#140D08]">
      ...
      {/* Background Real Cafe Storefront Night Image Overlay (70% Visibility) */}
      <div 
        className="absolute inset-0 bg-cover bg-center opacity-70 filter saturate-[1.05] contrast-[1.05] pointer-events-none transition-opacity duration-1000 scale-105"
        style={{
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#140D08]/70 via-[#140D08]/50 to-[#140D08]/95 pointer-events-none" />
